...
export function ProjectsList({
  ...
  return (
    <div className="grid min-h-0 content-center gap-y-[clamp(12px,1.2vw,20px)] overflow-y-auto p-pad [container-name:projects] [container-type:size] carousel:overflow-y-hidden">
      {label && (
